...
void check_solving_quadratic(const int count, const double x1, const double x2,
                             const double a, const double b, const double c,
                             int *test_num, int*  cor_num)
{
    T_ans ans = {0,0,0};
...
void check_solving_line (const int count, const int x1, const int x2,
